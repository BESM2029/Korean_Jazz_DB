    ...
    try{ 
        ...
        this.gdb.begin_profiling("insert_band");
            ...
            for(let ii in bandMemberObjIdArray) {
              ...
              let BandMemberEdge = {_src:{db:db_name, table:artist_table_name, _id: memberObjId}, _dst:{db:db_name, table:band_table_name, _id: bandID}};  // how can put role?
...
//                 let allMatchesG = KJDB.constructGraph(MatchScorePlayers); 
//                 console.log("################ All Maches within Dates ##############")
//                 allMatchesG.printGraphStructure();

//                 let playerMatchG = player_id ? KJDB.getPlayerGraph(player_id, allMatchesG) : allMatchesG;
//                 let matches = oppoent_id ? KJDB.getPlayerGraph(oppoent_id, playerMatchG) : playerMatchG;
...
//                 let player1MatchG = player1_id ? KJDB.getPlayerGraph(player1_id, allMatchesG) : allMatchesG;
//                 let player1N2MatchG = player2_id ? KJDB.getPlayerGraph(player2_id, player1MatchG) : player1MatchG;
//                 let op1Matches = oppoent1_id ? KJDB.getPlayerGraph(oppoent1_id, player1N2MatchG) : player1N2MatchG;
//                 let op1N2Matches = oppoent2_id ? KJDB.getPlayerGraph(oppoent2_id, op1Matches) : op1Matches;
//                 console.log("################ Given Player's Maches within Dates ##############")
